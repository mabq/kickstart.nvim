  ...
  },
  {
    ...
    opts = {
      settings = {
        ...
        -- formatting is handled by Conform, see below
      },
    },
  },
  {
    -- Basic, default LSP configurations for various LSP servers
    ...
    dependencies = {
      ...
      { 'j-hui/fidget.nvim', opts = {} }, -- opts to force load
    ...
    config = function()
      ...
      local servers = {
        ...
        --    Installed as a neovim plugin below.
